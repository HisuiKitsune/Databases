...
insert into endereco(cep, bairro, lgr, cod_regiao, cpf, id_cid)
values (21170102, 'Bangu', 1130, 3, '17109786781', 1);
insert into endereco(cep, bairro, lgr, cod_regiao, cpf, id_cid)
values (20013528, 'Realengo', 50, 3, '02541132178', 1);
insert into endereco(cep, bairro, lgr, cod_regiao, cpf, id_cid)
values (25022528, 'Catete', 220, 1, '02542032178', 1);


insert into cidade(nome_cid) values ('Rio de Janeiro');
